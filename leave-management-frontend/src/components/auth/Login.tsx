  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#faf8ff]">
      ...
      <div className="relative z-20 w-full max-w-md px-4 py-8 animate-in fade-in zoom-in duration-500">
        <div className="bg-white/90 backdrop-blur-2xl p-10 md:p-12 rounded-[40px] shadow-2xl shadow-blue-900/10 border border-white relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative">
            ...
            <Button 
              type="submit" 
              className="w-full bg-[#1e3a8a] hover:bg-[#00236f] text-white py-4 rounded-xl font-bold shadow-lg shadow-blue-900/10 hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 border-none text-xs uppercase tracking-widest mt-8" 
              disabled={loading}
            >
              {loading ? (
